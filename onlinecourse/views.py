...
def popular_course_list(request):
    ...
    if request.method == 'GET':
        ...
        path(route='', view=views.popular_course_list, name='popular_course_list'),path(route='', view=views.popular_course_list, name='popular_course_list'),path(route='', view=views.popular_course_list, name='popular_course_list'),path(route='', view=views.popular_course_list, name='popular_course_list'),
...
# add a view to read the requested course and send context to course_detail.html template.
